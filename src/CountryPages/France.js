...
const France = () => {
  ...
  useEffect(() => {
    const itineraryRef = collection(db, 'countries', countryName, 'itineraries');
    ...
    return () => unsubscribe();
  }, [countryName]); // Ensure to include dependencies for proper effect management
    ...
    <div className='App'>
      <div className="country-page">
        ...
        <div className="country-banner-row">
          <CountryBanner country={countryName}></CountryBanner>
        </div>
